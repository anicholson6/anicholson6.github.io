...
Detailed technical write-ups of my Georgia Tech master's coursework (Jan 2023-Aug 2025). Each README discusses the problem statement, implementation strategies, and experimental results for a specific project. Courses include Machine Learning, Reinforcement Learning, Machine Learning for Trading, Natural Language Processing, and Knowledge Based AI.

![images](https://github.com/anicholson6/MSCS-Portfolio/blob/main/images/RL-Overcooked.png)

*Example of RL project on multi-agent workers in an Overcooked style environment.*

----------------------

## Professional Projects 🏠
### [Solar Energy Accessibility Analysis](https://github.com/anicholson6/Personal-Portfolio/tree/main/DS4A_Capstone) 🌤️
...
![images](https://github.com/anicholson6/Personal-Portfolio/blob/main/DS4A_Capstone/Datafolio_PNG.png)
